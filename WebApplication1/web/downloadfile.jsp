...
<%	String ft=request.getParameter("ft").trim();
	...
	//out.println(id1);	
		...
		File sourceFile = new File(
				"D:\\project2022\\SecurityEvaluationofPatternClassifiersunderAttack2021\\WebApplication1\\web\\upload\\"+sun);

		File destFile = new File(
				"D:\\project2022\\SecurityEvaluationofPatternClassifiersunderAttack2021\\WebApplication1\\web\\download\\"+sun);
