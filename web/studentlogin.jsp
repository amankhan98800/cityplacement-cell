...
<body>
  ...
  <div class="w3-container" id="contact" style="margin-top:100px">
    <h1 class="w3-xxxlarge w3-text-red" align="center"><b>STUDENT LOGIN</b></h1>
  ...
  <tr>
    ...
    <td>
      ...
      <div align="left">
        ...
        <a href="studentsignup.jsp" class="style1">&nbsp New User?</a></div></td>
  </tr>
</table>
...
try
{
   ...
   String u=request.getParameter("textfield").trim();
	  ...
	  rs=stmt.executeQuery("select * from student where semail="+"'"+u+"'"+" and spass="+"'"+p+"' and status='Approved' ");
...
//		//session.setAttribute("pwd",p);
		            ...
		            response.sendRedirect("studenthome.jsp?semail="+semail+""); 
		}
		  else
		 {
	out.println( "<script>alert('Login Unsuccess');window.location='studentlogin.jsp';</script>");
